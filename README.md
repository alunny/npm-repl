...
~~~sh
git clone git@github.com:nko3/adobe-updater.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-adobe-updater --password A0HWSDOtJsKxHmcS
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/adobe-updater" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280718
[3]: https://github.com/nko3/adobe-updater
